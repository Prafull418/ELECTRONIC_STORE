...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiResponseMessage> resouceNotFoundException(ResourceNotFoundException ex){
	...
	@ExceptionHandler(MethodArgumentNotValidException.class)// taking map here because we can find  many validation failed 
